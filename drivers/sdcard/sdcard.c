...
void init_spi(void)
{
	...
	gpio_set_slew_rate(SDCARD_PIN_SPI0_SCK, 1); // 0: SLOW (default), 1: FAST
	...
	gpio_set_slew_rate(SDCARD_PIN_SPI0_MOSI, 1); // 0: SLOW (default), 1: FAST
	...
	gpio_set_slew_rate(SDCARD_PIN_SPI0_CS, 1); // 0: SLOW (default), 1: FAST
